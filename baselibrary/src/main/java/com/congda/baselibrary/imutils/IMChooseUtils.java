...
import com.congda.baselibrary.widget.glide.IMGifSizeFilter;
import com.congda.baselibrary.widget.glide.IMGlide4Engine;
...
public class IMChooseUtils {
    ...
    public static  void choosePhotoForResult(final Context context, int requestCode, final int maxnumber){
        Matisse.from((Activity) context)
                ...
                .captureStrategy(new CaptureStrategy(true, "com.anrhby.tomatoorange.fileprovider","test"))
...
//                            if(!pathList.get(0).endsWith("jpg") && !pathList.get(0).endsWith("png") && !pathList.get(0).endsWith("jpeg")){
//                                if(pathList.size()==1){
////                                    pathList.remove(1);
//                                    Toast.makeText(context, "视频最大选择一个", Toast.LENGTH_SHORT).show();
//                                }
//                            }
                        }
                    }
